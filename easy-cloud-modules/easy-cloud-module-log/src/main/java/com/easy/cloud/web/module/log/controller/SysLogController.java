...
public class SysLogController {
  ...
  @Autowired
  private ISysLogService operationLogService;
  ...
  public Object save(@Validated @RequestBody SysLogDTO sysLogDTO) {
    return operationLogService.save(sysLogDTO);
  }
  ...
  public Object update(@Validated @RequestBody SysLogDTO sysLogDTO) {
    return operationLogService.update(sysLogDTO);
  }
