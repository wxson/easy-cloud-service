...
import com.easy.cloud.web.module.route.domain.vo.DynamicGatewayRouteConfVO;
import lombok.Data;
...
@TableName(value = "db_dynamic_gateway_route_conf")
public class DynamicGatewayRouteConfDO implements IConverter<DynamicGatewayRouteConfVO> {
    /**
     * 文档ID
     */
    private String id;
