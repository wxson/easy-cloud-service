package com.easy.cloud.web.module.protocol.biz;
...
public class EasyCloudServiceProtocolBizApplication {

  public static void main(String[] args) {
    SpringApplication.run(EasyCloudServiceProtocolBizApplication.class, args);
  }
