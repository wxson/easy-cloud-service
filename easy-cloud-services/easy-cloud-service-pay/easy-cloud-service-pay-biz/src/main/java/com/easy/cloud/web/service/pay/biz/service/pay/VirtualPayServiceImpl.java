...
@Service
@AllArgsConstructor
public class VirtualPayServiceImpl implements IPayHandleService {
  ...
  public PayVO pay(PayDTO payDTO) {
    // 获取当前会员信息
    MemberVO memberVO = memberFeignClientService
        .getMemberDetailByUserId(SecurityUtils.getAuthenticationUser().getId()).getData();
    if (null == memberVO) {
