...
public class PayCallBackSignatureAspect {
    ...
    public Object payCallBackSignature(ProceedingJoinPoint proceedingJoinPoint, PayCallBackSignature payCallBackSignature) {
     ...
     * 微信支付校验
     * 商户必须使用微信支付公钥验证回调的签名。
     * 文档：https://pay.weixin.qq.com/wiki/doc/apiv3/wechatpay/wechatpay3_3.shtml
     *
     * @param proceedingJoinPoint 切点
     * @return java.lang.Object
     */
